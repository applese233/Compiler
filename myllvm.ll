...
declare dso_local i32 @_str_parseInt(i8* %0)
    ...
    @k = global i32 0
    @i = global i32 0
    @str1 = constant [4xi8] c"<< \00"
    @str2 = constant [2xi8] c"(\00"
    @str3 = constant [3xi8] c") \00"
    @str4 = constant [2xi8] c" \00"
    @str5 = constant [4xi8] c">> \00"
...
L1:
    %R7 = getelementptr inbounds [4xi8], [4xi8]* @str1, i32 0, i32 0
...
L12:
    %R26 = getelementptr inbounds [2xi8], [2xi8]* @str2, i32 0, i32 0
    call void @print(i8* %R26)
    %R27 = load i32, i32* @i
    %R28 = call i8* @toString(i32 %R27)
    call void @print(i8* %R28)
    %R29 = getelementptr inbounds [3xi8], [3xi8]* @str3, i32 0, i32 0
...
L13:
    ...
    %R31 = getelementptr inbounds [2xi8], [2xi8]* @str4, i32 0, i32 0
...
L15:
    %R39 = getelementptr inbounds [4xi8], [4xi8]* @str5, i32 0, i32 0
